...
class FundedAccountRules6k:
    """
    Challenge and Funded Account Rules Checker for a $6,000 Account.
    """
    def __init__(self):
        # Account Configuration
        self.STARTING_BALANCE = 6000.0
        
        # Challenge Rules
        self.PROFIT_TARGET = 480.0     # 8% of 6k
        self.MAX_LOSS_LIMIT = 600.0    # 10% of 6k
        self.DAILY_LOSS_LIMIT = 300.0  # 5% of 6k
    ...
    def check_daily_loss(self):
        """
        Check if the account has hit the Daily Loss Limit of $300.
    ...
    def check_max_loss(self):
        """
        Check if the account has hit the Max Loss Limit of $600.
        Returns: (bool, str) - True if safe, False if limit hit.
        """
        account_info = mt5.account_info()
        if account_info is None:
    ...
    def check_profit_target(self):
        """
        Check if the account has reached the Profit Target of $480.
        """
        account_info = mt5.account_info()
        if account_info is None:
            return False, "Failed to get account info"
...
if __name__ == "__main__":
    ...
    if mt5.initialize():
        checker = FundedAccountRules6k()
        print("Checking $6k Funded Account Rules...")
